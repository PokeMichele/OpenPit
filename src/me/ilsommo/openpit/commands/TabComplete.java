...
public class TabComplete implements TabCompleter {
  ...
  private static final String[] COMMANDS = { "spawnitems", "giveitem", "setevent", "setgold", "reload", "kills", "levelup", "help", "stats", "goldstart", "respawn", "enchant", "createholo", "spawnperks", "shop" };
